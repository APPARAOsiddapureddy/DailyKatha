...
class _OtpScreenState extends ConsumerState<OtpScreen> {
  ...
  bool get _isTestPrefix =>
      widget.args.phoneDigits.length == 10 && widget.args.phoneDigits.startsWith('123456');
  ...
  void _onDigitChanged(int index, String value) {
    ...
    if (_complete) {
      // Avoid verifying inside the same notification phase as TextField updates (can interact badly with async verify).
      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (mounted) _verify();
      });
    }
